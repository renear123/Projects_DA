...
CREATE TABLE IF NOT EXISTS Detalle_Promociones(
	id_DPromocion int PRIMARY KEY NOT NULL,
	id_producto int NOT NULL,
	id_promocion int NOT NULL,
	FOREIGN KEY(id_producto) REFERENCES productos(id_producto),
	FOREIGN KEY(id_promocion) REFERENCES Promociones(id_promocion)
...
insert into Pagos(id_Pago,Metodo_Pago,Banco,Franquisia)
...
insert into Detalles_Venta (id_dventa, id_producto, id_venta, des_producto, cantidad, precio_final)
values (12395,73658,52356, 0.15, 2, 5.39),
 		(12396,79343,52356, 0.10, 1, 1.53),
		(12397,75469,52356, 0, 4, 7.56),
 		(12963,79343,59893, 0.10, 5, 1.53),
		(12784,75469,59893, 0.15, 2, 6.43),
 		(12336,79843,56898, 0.05, 1, 2.82),
		(12665,75469,59893, 0, 1, 7.56),
 		(12554,79612,59871, 0.10, 2, 2.52),
		(12449,75469,59893, 0.15, 5, 6.43),
 		(12887,73658,59893, 0.20, 9, 5.08)
...
insert into Detalle_Promociones (id_dpromocion, id_producto, id_promocion)
values  (63236,73658,45662),
 		(69965,73658,45887),
		(68859,74569,42336),
 		(67542,78956,47896),
		(66541,78423,47896),
